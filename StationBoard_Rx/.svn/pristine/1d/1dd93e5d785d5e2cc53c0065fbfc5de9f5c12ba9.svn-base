/** StationBoard - Telemetry definition
  * Warthog Robotics
...
/* Includes module configuration and protocol */
#include <StationBoard/Telemetry/telemetry_configuration.h>
#include <StationBoard/Telemetry/telemetry_protocol.h>
